...
Scenario: Generate purchase order when stock is critically low
Given the inventory has "Milk" with quantity 1 and threshold 5
When the system checks stock levels
Then it should automatically generate a purchase order for "Milk"
...
Scenario: Generate purchase orders for multiple critically low ingredients
Given the inventory has "Butter" with quantity 2 and threshold 5
And the inventory has "Flour" with quantity 1 and threshold 4
When the system checks stock levels
Then it should generate purchase orders for "Butter" and "Flour"