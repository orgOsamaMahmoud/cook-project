...
public class NotificationManager {
    ...
    public void addTimedNotification(Notification notification) {
        ...
        if (added != null) {
            ...
            // Fix for the boolean check - use direct assignment
            added.setRequiresConfirmation(notification.isRequiresConfirmation());

            // Use a simple date format directly instead of relying on a class variable
    ...
    // Add this method to your existing NotificationManager class
    public void sendNotification(KitchenManager manager, Notification notification) {
        // In a real implementation, this would send via email, SMS, etc.
        // For testing purposes, we just add it to the manager's notifications
        manager.addNotification(notification);

        // Also store in our notifications map
        notifications.put(notification.getNotificationId(), notification);
